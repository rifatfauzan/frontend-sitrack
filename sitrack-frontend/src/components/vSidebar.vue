<template>
  <div>
    ...
    <button 
      @click="toggleSidebar" 
      :class="[
        'lg:hidden fixed top-3 left-4 z-50 p-2 rounded-md hover:bg-gray-100 transition-colors',
    ...
    <div 
      :class="[
        'w-64 h-screen bg-[#222222] flex flex-col justify-between font-sans fixed lg:static transition-transform duration-300 ease-in-out z-40',
